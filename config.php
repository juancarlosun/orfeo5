...
$entidad= "SkinaTech";                 //Acronimo de la empresa  //Nombre de la EmpresaCD
$entidad_largo= 'Skina Technologies SAS';   //Variable usada generalmente para los titulos en informes.
$nit_entidad = '000.000.000-0';             // Nit de la empresa
$entidad_tel =  '+571 2262080';             //Telefono o PBX de la empresa.
$entidad_contacto = "www.skinatech.com";    //URL de contacto de la empresa o entidad
...
$servicio = "orfeo55";               // Nombre de la base de datos de ORFEO
$usuario = "postgres";                    // Usuario de conexion
$contrasena= "123";           // Contraseña
$db = $servicio;

//#############  Servidor de correo Electronico

$servidor_mail="mail.skinatech.com";  //Servidor de consulta de correo
...
$servidor_mail_smtp="mail.skinatech.com";  // Servidor de Salida
$puerto_mail_smtp=587;                     // Puerto del servidor de Mail (25 | 587)
$cuenta_mail="pruebas@skinatech.com";      // Usuario de conexion
$contrasena_mail="Cah2ii@l4phi";           //  Contrasena
